    ...
    try:
        if (op>0 and op< 6):
            if op==1:
                ...
                continu=int(input("Deseas proceder al pago? 1)otro pedido 2)cancelar pedido 3)pagar: "))
                if continu== 2:
            ...
            if op==2:
                ...
                print(f"El total a pagar es: ${totalap}")
                continu=int(input("Deseas proceder al pago? 1)otro pedido 2)candelar pedido 3)pagar: "))
                if continu== 2:
                    print("Cierre exitoso no se hizo ningun cobro")
                    sw=0
                elif continu==3:
